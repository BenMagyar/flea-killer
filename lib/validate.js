...
const typeURL = {
        ...
        game: /http:\/\/www\.fleaflicker\.com\/[a-z]{3,5}\/leagues\/[0-9]{3,7}\/scores\/[0-9]{7,9}/
      };
...
exports.leagueId = function(leagueId) {
  return 9999 < parseInt(leagueId) && parseInt(leagueId) < 1000000;
};
...
// Valid gameid is in the correct range
exports.gameId = function(gameId) {
  return 9999999 < parseInt(gameId) && parseInt(gameId) < 99999999
}